/*--- Implementació de TransactionManager ---*/
...
TransactionManager::TransactionManager(const TransactionManager& orig) : BinarySearchTree<string,Transaction>(orig){
...
void TransactionManager::imprimirTransaccions(vector<Transaction> transaccions) const{
...
void TransactionManager::showAllAux(const BinaryTreeNode<string,Transaction>* n, int& i) const{
...
void TransactionManager::showAllReverseAux(const BinaryTreeNode<string,Transaction>* n, int& i) const{
...
void TransactionManager::sumaTransaccions(vector<Transaction> transaccions, float& suma) const{
    float amount = 0;
...
void TransactionManager::feesSinceTimeAux(const BinaryTreeNode<string,Transaction>* n, float& suma) const{ 
...
float TransactionManager::calculaBalanc(string nomFitxer){
